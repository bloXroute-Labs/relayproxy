...
func WithPlugin(delayerPlugin func(accountID string, msIntoSlot int64, cluster string, userAgent string, latency int64, clientIP string, logger zerolog.Logger, getHeaderTimeout map[string]int64, clientTimeoutMS int64, bidAdjustmentBufferTimeMs int64) (int64, int64, int64, error)) DataServiceOption {
	return func(s *DataService) {
